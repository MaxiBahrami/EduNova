...
namespace InsightAcademy.UI.Areas.Identity.Pages.Account
{
    public class ForgotPasswordModel : PageModel
    {
        ...
        public ForgotPasswordModel(UserManager<ApplicationUser> userManager, IEmailSender emailSender, IApplicationEmailSender applicationEmailSender)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                await _applicationEmailSender.ResetConfrimationEmail(
                    Input.Email,
